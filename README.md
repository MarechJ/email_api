...
http://email.marech.fr/doc/docs/#!/send/emailPOST
...
http post email.marech.fr/email 'to:=["mail@mail.com","marech_crew@hotmail.fr"]' 'body:=["mail@mail.com","mail2@mail2.fr"]'
http post email.marech.fr/email "to=juju <mail@mail.com>" "subject=hello" "body=bam" "cc=marech_crew@hotmail.fr" "from=Hey You <hey@blah.com>" "reply_to=mail@mail.com"
```
